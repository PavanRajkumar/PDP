...
class FeatureEngineer:
    ...
    Feature engineering
    """
    # SR = 44100 Hz -->44100 samples per second
    # so in 5 sec = 44100*5 = 220500
    # 220500/512(frame) = 431
    # Thus every feature produces (1,431) values except for mfcc which is (13,431)
    # Thus on cancatenation = (18,431)
    # and finally of finding mean  = (1,18) (axis change)
